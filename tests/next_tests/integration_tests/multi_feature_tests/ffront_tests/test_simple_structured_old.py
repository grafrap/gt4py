...
#     zavg = 0.5 * concat_where(JDim == domain_max_j, pp, pp + pp(JDim + 1))
...
# ) -> gtx.Field[[IDim, JDim, Kolor], float]:
#     zavg = 0.5 * concat_where(IDim == domain_max_i, pp, pp + pp(IDim + 1))
...
#         IDim == domain_max_i,
#         concat_where(JDim == domain_max_j, pp - pp, pp + pp(JDim + 1)),
#         concat_where(JDim == domain_max_j, pp(IDim + 1), pp(IDim + 1) + pp(JDim + 1)),
#     )
...
#         domain_max_j,
#         out=out,
#         domain={IDim: (0, domain_max_i), JDim: (0, domain_max_j), Kolor: (0, 3)},
#     )
...
#     zavgS = compute_zavgS_cartesian(pp, S_M, max_i, max_j)
